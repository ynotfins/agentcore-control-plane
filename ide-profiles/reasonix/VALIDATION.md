# Validation — Reasonix (DeepSeek-native terminal coding agent)
...
5. The delivered rules match `ide-profiles/reasonix/GLOBAL_RULES.md` (semantic parity; record any product-specific omission in `IDE_PROFILE.yaml`).
...
Record results and date in `IDE_PROFILE.yaml` (`last_validation_date`). Current recorded validation: 2026-08-04.
