...
5. The delivered rules match `ide-profiles/codex/GLOBAL_RULES.md` (semantic parity; record any product-specific omission in `IDE_PROFILE.yaml`).
6. Repo validators pass: `python scripts/bifrost/validate_contracts.py` and `python scripts/bifrost/test_contracts.py`.

Record results and date in `IDE_PROFILE.yaml` (`last_validation_date`). Current recorded validation: 2026-07-14.
