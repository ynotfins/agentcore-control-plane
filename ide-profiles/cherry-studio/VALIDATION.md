...
5. The delivered rules match `ide-profiles/cherry-studio/GLOBAL_RULES.md` (semantic parity; record any product-specific omission in `IDE_PROFILE.yaml`).
...
Record results and date in `IDE_PROFILE.yaml` (`last_validation_date`). Current recorded validation: 2026-07-20.
