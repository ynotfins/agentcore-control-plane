...
| **Runtime root** | `F:\AgentCore\runtime\bifrost` |
| **Endpoint** | `http://127.0.0.1:8080/mcp` |
| **Log location** | `F:\AgentCore\runtime\service-logs\bifrost-*.log` |
...
| **Log location** | `F:\AgentCore\runtime\service-logs\drift-*.log` |
...
| **Log location** | `F:\AgentCore\runtime\service-logs\backup-*.log` |
...
| **Log location** | `F:\AgentCore\runtime\service-logs\restore-test-*.log` |
...
| **Log location** | `F:\AgentCore\runtime\service-logs\maintenance-*.log` |
...
1. Check `F:\AgentCore\runtime\service-logs\bifrost-*.log`
2. Verify PostgreSQL is up (Bifrost depends on it)
3. Restart: `Stop-ScheduledTask ... ; Start-Sleep 2 ; Start-ScheduledTask ...`

### Backup failure
1. Check `F:\AgentCore\runtime\service-logs\backup-*.log` for error
...
2. Check restore log in `F:\AgentCore\runtime\service-logs\`
