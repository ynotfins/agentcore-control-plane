-- M4 migration rollback: restore assemble_context_window without quarantine filter.
...
DELETE FROM agentcore.schema_migrations WHERE version = 'm4.001_quarantine_filter';
