> **HISTORICAL — SUPERSEDED (2026-07-14). ARCHIVED PATH (2026-07-20). DO NOT EXECUTE.**
...
> Canonical archived location: `docs/operations/archive/handoffs/AGENTCORE_SWARM_ROLLOUT_HANDOFF_2026-06-30.md`.
> Current gateway authority: `PROJECT_ANCHOR.md` §0 / `docs/current/CURRENT_PROJECT_RECONSTRUCTION.md`.
