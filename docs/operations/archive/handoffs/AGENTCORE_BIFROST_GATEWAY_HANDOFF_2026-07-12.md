...
> **Historical cutover evidence (archived 2026-07-20 under `docs/operations/archive/handoffs/`).**
> Architecture decisions below remain valid under `BLUEPRINT.md` / `PROJECT_ANCHOR.md`. For live status after 2026-07-12 (memory live, M6, OpenRouter OAuth/JIT, Cherry/LangGraph enrollment), prefer `CONTEXT_BLOCK.md` §0a, `docs/operations/OPENROUTER_MCP.md`, `docs/operations/AUTONOMOUS_WORKFLOW_AND_STUDIO.md`, `docs/current/CURRENT_PROJECT_RECONSTRUCTION.md`, and dated audits under `audits/`.
> Pointer stub remains at `docs/handoffs/AGENTCORE_BIFROST_GATEWAY_HANDOFF_2026-07-12.md`.
