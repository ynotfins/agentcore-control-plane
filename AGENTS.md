...
- Cherry Studio must use only `agentcore-gateway` (no direct OpenRouter MCP). Full alignment 2026-07-20: enrolled MCP, AgentCore Workspace Agent, Global Memory off, memory lifecycle validated — `audits/CHERRY_GATEWAY_ENROLLMENT_2026-07-20.md`, `docs/operations/CHERRY_STUDIO_AGENTCORE.md`. Bifrost answers Cherry OPTIONS/HEAD `/mcp` probes with non-secret 200/204.
