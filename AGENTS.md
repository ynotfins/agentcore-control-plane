...
- Cherry Studio must use only `agentcore-gateway` (no direct OpenRouter MCP). Aligned + runtime-repaired 2026-07-20: official x64 install, enrolled MCP, AgentCore Workspace Agent (`deepseek:deepseek-v4-pro`), Global Memory off, Home UI + chat + memory lifecycle validated — `audits/CHERRY_GATEWAY_ENROLLMENT_2026-07-20.md`, `audits/CHERRY_RUNTIME_FAILURE_2026-07-20.md`, `docs/operations/CHERRY_STUDIO_AGENTCORE.md`. Bifrost answers Cherry OPTIONS/HEAD `/mcp` probes with non-secret 200/204.
